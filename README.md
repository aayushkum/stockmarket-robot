...
This is a personal project I've been working on, essentially creating a stock-trading robot that attempts to systematically identify  mispriced stocks within the S&P 500, and exploit those misprices. It's been inspired by the prevalance of trading bots in the modern stock market, and the idea that a company's underlying fundamentals should eventually be reflected in its stock price.
