...
This is a personal project I've been working on, essentially creating a stock-trading robot that attempts to suceed on the S&P 500. It's been inspired by the prevalance of trading bots in the modern stock market, and the idea that a company's underlying fundamentals should eventually be reflected in its stock price.
